...
archivo = "resultados_nic_chile_filtrados_ipv4.csv"
df = pd.read_csv(archivo)

# Filtrar solo los prefijos inválidos
...
print("Top 20 ASN con más prefijos inválidos en IPv4 (Chile):")
print(conteo_asn.head(20).to_string(index=False))

# Guardar resultados en un nuevo archivo si lo deseas
conteo_asn.to_csv("ranking_asn_invalidos_ipv4_chile.csv", index=False)
